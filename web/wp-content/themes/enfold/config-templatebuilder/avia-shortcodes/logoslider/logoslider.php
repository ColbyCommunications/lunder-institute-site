...
//						),
			...
			$c = array(
						array(
							...
							'desc'			=> __( 'Set a distance between the images - need when using box shadow outside. Both pixel and &percnt; based values are accepted. eg: 30px, 5&percnt;. Leave empty for none.', 'avia_framework' ),
							'std'			=> '',
							'required'		=> array( 'border', 'equals', '' )
						)
				);
